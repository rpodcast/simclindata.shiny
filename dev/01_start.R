...
##
golem::fill_desc(
  pkg_name = "simclindata.shiny", # The Name of the package containing the App
  ...
  repo_url = "https://github.com/rpodcast/simclindata.shiny" # The URL of the GitHub Repo (optional)
)
